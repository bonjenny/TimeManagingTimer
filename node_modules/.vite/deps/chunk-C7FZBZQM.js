import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-FIQQ5SAL.js";
import {
  insertCluster
} from "./chunk-65YW5HDA.js";
import {
  insertNode
} from "./chunk-4NR54AZC.js";
import {
  labelHelper
} from "./chunk-BCTENT6F.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-GXQ25YYZ-AYMDMR7X.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-42K2YHIH-MZWD6E26.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-3GB3LEHF.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-C7FZBZQM.js.map
